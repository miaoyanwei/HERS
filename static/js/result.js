$.get("/app/myapp/flex", function(data){
    ...
    rec_list.forEach((item,index)=>{
        ...
        + '<p>If the following configurations are applied, the annual energy bill is estimated to be <span>&#8364;</span><span id="totalcost-placeholder"></span></p>'
